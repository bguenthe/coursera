...
class Ship:
    def __init__(self, pos, vel, angle):
        ...
        self.ship_thrust_sound = simplegui.load_sound(
            "https://www.dropbox.com/s/ers1wh4tl71u0jv/thrust.ogg?dl=1")
...
class Asteroids:
    def __init__(self):
        ...
        self.soundtrack = simplegui.load_sound(
            "https://www.dropbox.com/s/f8ei5s7p51dlqm0/soundtrack.ogg?dl=1")
        self.missile_sound = simplegui.load_sound(
            "https://www.dropbox.com/s/l987ip6qll2d7n2/missile.ogg?dl=1")
        self.missile_sound.set_volume(.5)

        self.explosion_sound = simplegui.load_sound(
            "https://www.dropbox.com/s/davva0zzczcnjp9/explosion.ogg?dl=1")
    ...
    def keydown(self, key):
        ...
        if key == simplegui.KEY_MAP["space"]:
            ...
            self.missiles.append(Sprite([self.ship.pos[0] + (self.ship.radius * forward[0]),
                                        ...
                                        [self.ship.vel[0] + forward[0] * 2, self.ship.vel[1] + forward[1] * 2], 0, 0, self.missile_image, self.missile_info,
                                        self.missile_sound))
