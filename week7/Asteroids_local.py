...
class Ship:
    def __init__(self, pos, vel, angle):
        ...
        self.image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\double_ship.png")
        self.ship_thrust_sound = simplegui.load_sound(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\thrust.ogg")
...
class Asteroids:
    def __init__(self):
        ...
        self.debris_image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\debris2_blue.png")

        # nebula images - nebula_brown.png, nebula_blue.png
        self.nebula_info = ImageInfo([400, 300], [800, 600])
        self.nebula_image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\nebula_blue.f2014.png")

        # splash image
        self.splash_info = ImageInfo([200, 150], [400, 300])
        self.splash_image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\splash.png")

        # missile image - shot1.png, shot2.png, shot3.png
        self.missile_info = ImageInfo([5, 5], [10, 10], 3, 60)
        self.missile_image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\shot2.png")

        # asteroid images - asteroid_blue.png, asteroid_brown.png, asteroid_blend.png
        self.asteroid_info = ImageInfo([45, 45], [90, 90], 40)
        self.asteroid_image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\steroid_blue.png")

        # animated explosion - explosion_orange.png, explosion_blue.png, explosion_blue2.png, explosion_alpha.png
        self.explosion_info = ImageInfo([64, 64], [128, 128], 17, 24, True)
        self.explosion_image = simplegui.load_image(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\explosion_alpha.png")

        # sound assets purchased from sounddogs.com, please do not redistribute
        self.soundtrack = simplegui.load_sound(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\soundtrack.ogg")
        self.missile_sound = simplegui.load_sound(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\missile.ogg")
        self.missile_sound.set_volume(.5)

        self.explosion_sound = simplegui.load_sound(
            "C:\\Users\\claube\\Dropbox\\workspace_and_ideaprojects\\coursera\\gameassets\\asteroids\\explosion.ogg")
    ...
    def keydown(self, key):
        ...
        if key == simplegui.KEY_MAP["space"]:
            ...
            self.missiles.append(Sprite([self.ship.pos[0] + (self.ship.radius * forward[0]),
                                        ...
                                        [forward[0] * 2, forward[1] * 2], 0, 0, self.missile_image, self.missile_info,
                                        self.missile_sound))
    ...
    def draw(self, canvas):
        ...
        canvas.draw_text(str(self.ship.angle), [100, 100], 10, "White")
        forward = angle_to_vector(self.ship.angle)
        canvas.draw_text(str(forward[0]), [100, 120], 10, "White")
        canvas.draw_text(str(forward[1]), [100, 140], 10, "White")
